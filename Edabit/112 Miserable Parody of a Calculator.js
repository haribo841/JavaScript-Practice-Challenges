...
function calculator(str) {
    return evaluateArithmeticExpression(str);
}
...
assertThrows(() => calculator("1; globalThis.compromised = true"), SyntaxError)
assertThrows(() => calculator("process.exit()"), SyntaxError)
