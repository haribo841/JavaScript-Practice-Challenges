...
// test cases
const actual = [checkEquals([1, 2], [1, 2]), checkEquals([1, 2], [1, 3]),
...
// results
const expected = [true, false, false, true, false, false, true, false, false, true, false]

// messages
const message = ["", "", "Are you sure this is true?", "", "Should return false", "", "", "", "", "", ""]
